...
friend is a chat bot built on the [Hubot][hubot] framework. It was
...
### Running friend Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start friend locally by running:
...
Then you can interact with friend by typing `friend help`.

    friend> friend help
    friend animate me <query> - The same thing as `image me`, except adds [snip]
    friend help - Displays all of the help commands that friend knows about.
    ...
